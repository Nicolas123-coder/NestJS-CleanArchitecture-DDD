...
describe('UserPrismaRepository integration tests', () => {
  ...
  it('should throws error when entity not found by id', async () => {
  ...
  it('should throws error on update method when entity not found by id', async () => {
    const entity = new UserEntity(UserDataBuilder({}))
  ...
  it('should throws error on delete when entity not found by id', async () => {
    const entity = new UserEntity(UserDataBuilder({}))
  ...
  it('should throws error on findByEmail when entity not found by id', async () => {
    await expect(() => sut.findByEmail('emailnotexistent@a.com')).rejects.toThrow(
      new NotFoundError(
        `UserModel not found using email emailnotexistent@a.com`,
      ),
    )
  })
  ...
  it('should throws error on emailExists when entity found by email', async () => {
    const entity = new UserEntity(UserDataBuilder({ email: 'a@a.com' }))
    await prismaService.user.create({
      data: entity.toJSON(),
    })
  ...
  describe('search method tests', () => {
    it('should apply only pagination when params are null', async () => {
